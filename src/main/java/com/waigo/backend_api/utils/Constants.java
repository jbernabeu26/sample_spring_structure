...
public class Constants {
    ...
    /** CUSTOM USER **/
    public final static int CUSTOMUSER_FIRSTNAME_MAX = 100;
    public final static int CUSTOMUSER_FIRSTNAME_MIN = 2;
    public final static int CUSTOMUSER_LASTNAME_MAX = 100;
    public final static int CUSTOMUSER_LASTNAME_MIN = 2;
    public final static int CUSTOMUSER_DESCRIPTION_MAX = 500;
    public final static int CUSTOMUSER_DESCRIPTION_MIN = 100;
    /** EVENT **/
