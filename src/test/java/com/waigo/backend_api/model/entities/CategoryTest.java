...
public class CategoryTest {
    ...
    public void createCategoryLessThan30Chars2(){
        ...
        categoryRepository.saveAndFlush(category);
        Assertions.assertThat(categoryRepository.findByName(data.getCategory_name_10_Chars()).isPresent()).isTrue();
    }
    ...
    public void createCategoryWith30Chars(){
        ...
        categoryRepository.saveAndFlush(category);
        Assertions.assertThat(categoryRepository.findByName(data.getCategory_name_30_Chars())).isNotNull();
    }
    ...
    public void createCategoryWith3Chars(){
        ...
        categoryRepository.saveAndFlush(category);
        Assertions.assertThat(categoryRepository.findByName(data.getCategory_name_3_Chars())).isNotNull();
    }
